...
# Charger les données
data <- read.csv("C:/Users/User/OneDrive - ENSEA/[L3]/Bureau/HAKIM_EURIA_M1/BE/Data/Base_BE_P.csv", stringsAsFactors = TRUE, header = TRUE)
...
server <- function(input, output, session) {
  ...
  counties <- geojsonio::geojson_read("C:/Users/User/OneDrive - ENSEA/[L3]/Bureau/HAKIM_EURIA_M1/BE/Tornades_USA_BE_Euria/Test/gadm41_USA_2.json", what = "sp")
